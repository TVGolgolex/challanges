...
import de.pascxl.challanges.utils.config.converter.*;
...
public class PaperInternalConverter {
    ...
    public PaperInternalConverter() {
        try {
            addConverter(Primitive.class);
            addConverter(Config.class);
            addConverter(de.pascxl.challanges.utils.config.converter.List.class);
    ...
    public void addConverter(Class converter) throws InvalidConverterException
    {
        ...
        try {
            Converter converter1 = (Converter) converter.getConstructor(PaperInternalConverter.class).newInstance(this);
    ...
    public void fromConfig(YamlConfigPaper config, Field field, PaperConfigSection root, String path) throws Exception {
    ...
    public void toConfig(YamlConfigPaper config, Field field, PaperConfigSection root, String path) throws Exception {
        Object obj = field.get(config);
