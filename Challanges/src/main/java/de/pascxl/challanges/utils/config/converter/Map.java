...
public class Map implements Converter {
    ...
    public Map( PaperInternalConverter paperInternalConverter) {
    ...
    public Object toConfig( Class<?> type, Object obj, ParameterizedType genericType ) throws Exception {
        ...
        for ( java.util.Map.Entry<Object, Object> entry : map1.entrySet() ) {
            ...
            Converter converter = paperInternalConverter.getConverter( clazz );
    ...
    public Object fromConfig( Class type, Object section, ParameterizedType genericType ) throws Exception {
        if ( genericType != null ) {
            ...
            if ( genericType.getActualTypeArguments().length == 2 ) {
                ...
                java.util.Map<?, ?> map1 = ( section instanceof java.util.Map ) ? (java.util.Map) section : ( (PaperConfigSection) section ).getRawMap();
                ...
                Converter converter = paperInternalConverter.getConverter( (Class) genericType.getRawType() );

                if ( converter != null ) {
                    return converter.fromConfig( (Class) genericType.getRawType(), section, null );
                }

                return ( section instanceof java.util.Map ) ? (java.util.Map) section : ( (PaperConfigSection) section ).getRawMap();
            }
